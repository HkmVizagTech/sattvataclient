...
// Use VITE_API_URL in production (set in Vercel env vars) for direct Railway backend calls.
// Fall back to /api for local dev where Vite proxy forwards to localhost:5000.
